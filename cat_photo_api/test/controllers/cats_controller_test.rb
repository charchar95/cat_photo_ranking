...
class CatsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cat" do
    assert_difference('Cat.count') do
      post cats_url, params: { cat: { comments: @cat.comments, img: @cat.img, name: @cat.name } }, as: :json
    end
  ...
  test "should update cat" do
    patch cat_url(@cat), params: { cat: { comments: @cat.comments, img: @cat.img, name: @cat.name } }, as: :json
    assert_response 200
  end
